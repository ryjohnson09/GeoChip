  ...
  sidebarLayout(
    sidebarPanel(
      ...
      fluidRow(column(12,
                      ...
                      ### Probe Categories ###
                      ########################
                      selectInput('probe_type', 'Probe Type:', choices = c("All", "Gene Category"), 
                                  selected = "All"),
                      checkboxGroupInput("geneCategory", "Gene Category:", 
                                         choices = c("CARBON_CYCLING", "SECONDARY_METABOLISM", "ELECTRON_TRANSFER", 
                                                     "VIRUS", "STRESS", "ORGANIC_REMEDIATION", "VIRULENCE", 
                                                     "NITROGEN", "METAL_HOMEOSTASIS", "OTHER", "SULFUR", "PHOSPHORUS"))
      )),
